...
<head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge"> @yield('meta')
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{ asset('img/logo.png')}}" alt="Filma24" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Fima24</span>
        </a>
           ...
           with font-awesome or any other icon font library -->
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('serie.create')}}" class="nav-link">
                                    <i class="fa fa-circle-o nav-icon"></i>
                                    <p>Create Serie</p>
                                </a>
                            </li>
